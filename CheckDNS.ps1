...
$count=0
$date=(get-date)
echo "-----------------DNS Report-------------------" >> C:\Users\user\Desktop\PWSH\informe.txt
echo $date >> C:\Users\user\Desktop\PWSH\informe.txt
echo "----------------------------------------------" >> C:\Users\user\Desktop\PWSH\informe.txt
...
foreach($name in Get-Content C:\Users\user\Desktop\PWSH\lista.txt) {
	...
	if($respuesta -ne $null){
		...
		echo "$salida" >> C:\Users\user\Desktop\PWSH\informe.txt
		}
	else{
		$salidaf=$dns+" no encontrado (Ping:"+$ping+")"
		echo "$salidaf" >> C:\Users\user\Desktop\PWSH\informe.txt
		$count++
	}
}
if($count -gt 0){ 
	...
	echo "----------------------------------------------" >> C:\Users\user\Desktop\PWSH\informe.txt
	echo "$badnames" >> C:\Users\user\Desktop\PWSH\informe.txt
}
